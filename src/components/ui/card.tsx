    ...
    <div
      ...
      className={cn(
        "rounded-2xl border text-card-foreground transition-all duration-300",
        {
          ...
          "glass border-border/50": variant === "glass",
          "gradient-card border-border/30 shadow-card": variant === "gradient",
          "bg-card shadow-card hover:shadow-lg hover:-translate-y-1 cursor-pointer":
            variant === "interactive",
        },
        className
      )}
